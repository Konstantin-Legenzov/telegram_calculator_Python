...
def call_back(query):
    ...
    data = query.data #теперь дата, то то возвращает кнопка 
    ...
    if (value != old_value and value != '') or ('0' != old_value and value == ''):
        if value == '':
            ...
            old_value = '0'
        else: bot.edit_message_text(chat_id=query.message.chat.id, message_id=query.message.message_id, text=value,
                                    reply_markup=keyboard)
    old_value = value
